# Snapshot report for `test/babel6/macro.js`
...
> Snapshot 1
    ...
    const dynamicStyles = props => ({␊
      styles: <_JSXStyle id={"3078955491"} dynamic={[props.color]}>{`div.__jsx-style-dynamic-selector{color:${props.color};}`}</_JSXStyle>,␊
      className: _JSXStyle.dynamic([['3078955491', [props.color]]])␊
    });␊
    ␊
    const test = {␊
      styles: <_JSXStyle id={"2052294191"}>{"div.jsx-2052294191{color:red;}"}</_JSXStyle>,␊
